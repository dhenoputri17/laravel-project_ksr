                                ...
                                <div class="row mb-3 mx-3 align-items-center">
                                    ...
                                    <div class="col-lg-4 col-md-8">
                                        <input type="text" data-toggle="tooltip" title="Kode Kasir" class="form-control"
                                            ...
                                            value="{{ app('App\Http\Controllers\DashboardController')->kodekasir() }}" required>
    ...
    <div class="modal fade" id="modal-ukasir">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ url('/ubah-kasir') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="card">
                                ...
                                {{-- <div class="row mb-3 mx-3 align-items-center">
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <input type="text" data-toggle="tooltip" title="Masukkan Nama Produk"
                                            class="form-control" id="pwd_kasir" name="pwd_kasir" disabled>
                                        <div class="valid-feedback" id="R_pwd_kasir">
                                        </div>
                                    </div>
                                </div> --}}
                        </div>
