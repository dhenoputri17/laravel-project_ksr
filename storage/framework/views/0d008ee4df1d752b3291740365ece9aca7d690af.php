                        ...
                        <?php if(session('berhasil')): ?>
                            ...
                            <script>
                                $(document).ready(function() {
                                    $('#nota_id').val('<?php echo e(Session::get('transaksiId')); ?>');
    ...
    <div class="modal fade" id="modal-bayar">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('/selesai-bayar')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="card">
                            <div class="row">
                                    ...
                                    <div class="row mb-3 align-items-center">
                                        ...
                                        <div class="col-lg-4 col-md-8">
                                            <input type="text" data-toggle="tooltip" title="Nota Pembayaran"
                                                ...
                                                value="<?php echo e(app('App\Http\Controllers\KasirController')->notrans()); ?>"
                                                required>
...
<?php $__env->startSection('jsku'); ?>
    ...
    <script>
        var nama = "<?php echo e($user->name); ?>";
        var idka = "<?php echo e($user->id); ?>";
...
<?php echo $__env->make('layouts.kastemp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projeksaya\resources\views/pages/kasir/index.blade.php ENDPATH**/ ?>