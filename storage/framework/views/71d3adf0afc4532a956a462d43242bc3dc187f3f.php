    ...
    <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('/simpan-produk')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row mb-3 align-items-center">
                                        ...
                                        <div class="col-lg-4 col-md-8">
                                            <input type="text" data-toggle="tooltip" title="Kode Produk"
                                                ...
                                                value="<?php echo e(app('App\Http\Controllers\ProdukController')->code()); ?>" required>
    ...
    <div class="modal fade" id="modal-ubah">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('/rubah-produk')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="card">
                            <div class="row">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projeksaya\resources\views/pages/produk/index.blade.php ENDPATH**/ ?>