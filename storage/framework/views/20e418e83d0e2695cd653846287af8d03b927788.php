                                    ...
                                    <div class="row mb-3 align-items-center">
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <select class="select2 form-control custom-select"
                                                style="width: 100%; height:36px;" id="namakas" name="namakas">
                                                <option selected="true" disabled>Pilih</option>
                                                <?php $__currentLoopData = $ktr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row align-items-right text-right">
                                        <a href="<?php echo e(url('/transaksi-filter')); ?>" class="btn btn-cyan">Reset Filter</a>
                                        &nbsp;&nbsp; &nbsp;
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="tabel-penjualan" class="table table-sm table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $prd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-center"><?php echo e($barang->id); ?></td>
                                        <td><?php echo e($barang->kode_produk); ?></td>
                                        <td><?php echo e($barang->nama_produk); ?></td>
                                        <td><?php echo e($barang->kategori->nama_kategori); ?></td>
                                        <td class="text-right"><?php echo e($barang->harga); ?></td>
                                        <td class="text-center"><?php echo e($barang->stok_awal); ?></td>
                                        <td class="text-center"><?php echo e($barang->stok_akhir); ?></td>
                                        <td class="text-center"><b><?php echo e($barang->jual()); ?></b></td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                                <tfoot>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projeksaya\resources\views/pages/laporan/jualbrg.blade.php ENDPATH**/ ?>